...
myViewport.view.setValues(viewOffsetY=2.0*nY*ylength)
...
session.printToFile(fileName = 'Mises-3', format = PNG, canvasObjects = (myViewport, ))
print 'File Mises-3.png has been saved in the working directory. Please check!'
